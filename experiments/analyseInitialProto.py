...
PROTOTYPES_CSV_FILENAME = "initial-prototypes.csv"  # 'prototypes.csv'
OUTPUT_PLOT_FILENAME = 'initial_prototype_analysis_grid_layout.png' #'prototype_analysis_grid_layout.png'
